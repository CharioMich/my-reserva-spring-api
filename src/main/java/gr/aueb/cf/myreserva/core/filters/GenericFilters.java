package gr.aueb.cf.myreserva.core.filters;
...
public abstract class GenericFilters {
    ...
    public int getPage() {
        return Math.max(page, 0);   // Only positive pages or 0
    }
    ...
    public Sort getSort() {
        return Sort.by(getSortDirection(), getSortBy());    // return direction & properties
    }
